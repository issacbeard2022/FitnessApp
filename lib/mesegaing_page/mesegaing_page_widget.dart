...
class MesegaingPageWidget extends StatefulWidget {
  MesegaingPageWidget({
    Key key,
    this.chatUser,
  }) : super(key: key);
  ...
  @override
  _MesegaingPageWidgetState createState() => _MesegaingPageWidgetState();
}

class _MesegaingPageWidgetState extends State<MesegaingPageWidget> {
